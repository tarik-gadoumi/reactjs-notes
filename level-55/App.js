...
import './styles.css';
/**
 * ! this is how i made the job done !
 * * instead of using forwardRef , useImperetiveHandler  bla bla bla
 * * i think  my code is ugly... so  let's follow the pattern  mentionned above in the next level
 */
function MessagesDisplay({ messages, x }) {
  return (
    <div ref={x} role="log">
...
function App() {
  ...
  return (
    <div className="messaging-app">
      ...
      <MessagesDisplay x={messageDisplayRef} messages={messages} />
      <div>
